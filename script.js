...
function animateCarrousel() {
    ...
    imageElements[right].classList.add('landing-merch-img-center');
    imageElements[center].classList.add('landing-merch-img-left');
    imageElements[left].classList.add('landing-merch-img-right');
