...
const sentenceContainer = [document.getElementById('sentence1'), document.getElementById('sentence2'), document.getElementById('sentence3'), document.getElementById('sentence4')]

let currentIndex = 0;

function promoBanner() {
    if (currentIndex < sentenceContainer.length - 1) {
        sentenceContainer[currentIndex].classList.add('show-sentence');
        setTimeout(() => {
            sentenceContainer[currentIndex].classList.remove('show-sentence');
            currentIndex++;
            promoBanner();
        }, 5000);
    } else {
